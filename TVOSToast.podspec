#
#  Be sure to run `pod spec lint TVOSToast.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/Paul-Geppert/TVOSToast.git" }
  ...
  #s.preserve_paths = "TVOSToast/Resources"
